...
MakeCode Python is Here! Python is now available in MakeCode for Minecraft, and Microsoft will be bringing it to the other code MakeCode editors later this year. - [MakeCode Blog](https://makecode.com/blog/minecraft/python-release)
