...
[Flashing LED Strand with MakeCode](https://learn.adafruit.com/flashing-led-strand-with-makecode) from [Erin St Blaine](https://learn.adafruit.com/users/KathyCeceri).

[Rainbow Bottle Lamp with Fairy Lights](https://learn.adafruit.com/glowing-bottle-lamp) from [Kathy Ceceri](https://learn.adafruit.com/users/firepixie).
