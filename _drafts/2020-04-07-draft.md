...
BitPlayerprovides a micro:bit a 2-axis joystick like Gameboy or PSP controllers. It also includes another 6 programmable buttons labeled as L, R, A, B, C and D. For an immserive and interactive experience, the BitPlayer itself features a buzzer, a vibration motor and a Grove I2C port to connect additional peripherals - [TinkerGen](https://shop.tinkergen.com/bitplayer.html)
