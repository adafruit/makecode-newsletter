...
The initial plan of SD slot was for SD card support in MicroPython mode, but we found many users require wireless support for MakeCode Arcade. And so we designed a tiny SD size bluetooth module, also based on codal-microbit.
