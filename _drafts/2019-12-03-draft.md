...
[Deep Breathing Encouragement](https://twitter.com/motivatorlabs/status/1193922473336672257?s=21)
...
Rob Morrow writes "High school Fitness class students used woodshop tools last week to make balance boards. Art and Adafruit CPX microcontrollers added yesterday. Coded in MakeCode using accelerometer input. Every few seconds of balance = another NeoPixel lit. Light+sound party when 10 lit!" - [Twitter](https://twitter.com/morrill_rob/status/1192088615079137281)
...
New: [Desktop Dumster Fire](https://learn.adafruit.com/desktop-dumpster-fire/) from [Dano Wall](https://learn.adafruit.com/users/danowall).

[![](/assets/12032019/12102019-globe.png/)](https://learn.adafruit.com/make-a-snowglobe-with-circuit-playground-makecode)

Holiday classic: [Make a Snow Globe with Circuit Playground Express & MakeCodee](https://learn.adafruit.com/make-a-snowglobe-with-circuit-playground-makecode) from [Liz Clark](https://learn.adafruit.com/users/BlitzCityDIY).
